!(function (t) {
  ...
  function (t, n, r) {
    ...
    function c(t, n, r) {
      var e = {
        ...
        type: t.type || "GET",
        success: function (t) {
          0 === t.code ? n && n(t) : alert(t.msg || "interface error");
        },
        error: function (t) {
          r && r(t), alert("server error");
        },
      };
      "POST" === t.type &&
        t.data &&
    ...
    function s(t) {
      ...
      if (-1 == (t = "" + t).indexOf(".")) {
        for (var e = t.length - 1; e >= 0; e--)
          (n = r % 3 == 0 && 0 != r ? t.charAt(e) + "," + n : t.charAt(e) + n),
            r++;
        return (t = n);
      }
      for (var i = t.indexOf(".") - 1; i >= 0; i--)
        (n = r % 3 == 0 && 0 != r ? t.charAt(i) + "," + n : t.charAt(i) + n),
          r++;
      return (t = n + (t + "00").substr((t + "00").indexOf("."), 3));
    }
  },
  function (t, n) {
    ...
    if (r(9)) {
      var e = r(31),
        ...
        Tt = {
          ...
          reverse: function () {
            for (
              var t, n = Et(this).length, r = Math.floor(n / 2), e = 0;
              e < r;
            ...
            ? ((p = r(function (t, r, e, i) {
                ...
                if (S(r)) {
                  ...
                  if (void 0 === i) {
                    ...
                    if ((u = y - v) < 0) throw U("Wrong length!");
                  } else if ((u = d(i) * n) + v > y) throw U("Wrong length!");
                  c = u / n;
  ...
  function (t, n, r) {
    var e = r(98),
      i = r(71).concat("length", "prototype");
    n.f =
  ...
  function (t, n, r) {
    ...
    function N(t, n, r) {
      ...
      for (
        (t = O(t)) != t || t === w
          ...
          : ((e = M(P(t) / A)),
            t * (o = E(2, -e)) < 1 && (e--, (o *= 2)),
            (t += e + f >= 1 ? s / o : s * E(2, 1 - f)) * o >= 2 &&
              (e++, (o /= 2)),
            e + f >= a
              ? ((i = 0), (e = a))
              : e + f >= 1
              ? ((i = (t * o - 1) * E(2, n)), (e += f))
              : ((i = t * E(2, f - 1) * E(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & i, i /= 256, n -= 8
      );
    ...
    function G(t, n, r, e, i, o) {
      ...
      for (var c = t[F]._b, a = u + t[I], f = e(+i), s = 0; s < n; s++)
        c[a + s] = f[o ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
  ...
  function (t, n, r) {
    r(9) &&
      "g" != /./g.flags &&
      r(10).f(RegExp.prototype, "flags", { configurable: !0, get: r(52) });
  },
  function (t, n) {
    t.exports = function (t) {
      try {
  ...
  function (t, n, r) {
    ...
    var e,
      ...
      b = (t.exports = r(63)("WeakMap", y, m, f, !0, !0));
    h &&
      v &&
  ...
  function (t, n, r) {
    ...
    var e = r(4),
      ...
      X = function (t) {
        ...
        return (
          !(this === G && i(V, t) && !i(B, t)) &&
          (!(n || !i(this, t) || !i(V, t) || (i(this, L) && this[L][t])) || n)
        );
      },
      Q = function (t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== G || !i(V, n) || i(B, n))) {
          var r = j(t, n);
          return (
            !r || !i(V, n) || (i(t, L) && t[L][n]) || (r.enumerable = !0), r
          );
        }
      },
      Z = function (t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; )
          i(V, (n = r[o++])) || n == L || n == a || e.push(n);
        return e;
      },
      tt = function (t) {
        for (
          var n, r = t === G, e = N(r ? B : S(t)), o = [], u = 0;
          e.length > u;

        )
          !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    U ||
      (c(
        (R = function () {
          ...
          return o && z && J(G, t, { configurable: !0, set: n }), Y(t);
        }).prototype,
        "toString",
        function () {
          return this._k;
      ...
      (r(51).f = X),
      (P.f = tt),
      o && !r(31) && c(G, "propertyIsEnumerable", X, !0),
      (p.f = function (t) {
        return Y(v(t));
      })),
      u(u.G + u.W + u.F * !U, { Symbol: R });
    for (
      var nt =
    ...
    u(u.S + u.F * ot, "Object", {
      ...
      R.prototype[D] || r(13)(R.prototype, D, R.prototype.valueOf),
      l(R, "Symbol"),
      l(Math, "Math", !0),
      l(e.JSON, "JSON", !0);
  },
  ...
  function (t, n, r) {
    var e = r(0);
    e(e.S + e.F * !r(9), "Object", { defineProperties: r(99) });
  },
  function (t, n, r) {
    var e = r(17),
      i = r(18).f;
  ...
  function (t, n, r) {
    ...
    var e = r(0),
      i = r(17),
      o = [].join;
    e(e.P + e.F * (r(50) != Object || !r(24)(o)), "Array", {
      join: function (t) {
  ...
  function (t, n, r) {
    ...
    var e = r(0),
      i = r(112);
    e(e.P + e.F * !r(24)([].reduceRight, !0), "Array", {
      reduceRight: function (t) {
  ...
  function (t, n, r) {
    var e = r(0);
    e(e.P, "Array", { copyWithin: r(113) }), r(33)("copyWithin");
  },
  function (t, n, r) {
    var e = r(0);
    e(e.P, "Array", { fill: r(87) }), r(33)("fill");
  },
  function (t, n, r) {
    "use strict";
    var e = r(0),
        ...
        function (t, n) {
          ...
          for (var x, S = "", w = 0, _ = 0; _ < m.length; _++) {
            ...
            for (
              ...
              M.push(void 0 === (x = b[P]) ? x : String(x));
            var A = b.groups;
            if (v) {
              var F = [O].concat(M, E, h);
              void 0 !== A && F.push(A);
              var j = String(n.apply(void 0, F));
            } else j = d(O, h, E, M, A, n);
        ...
        [
          ...
          function (t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              if (
                null === O ||
                (_ = l(c(m.lastIndex + (p ? 0 : S)), h.length)) === x
              )
                S = u(h, S, g);
              else {
  ...
  function (t, n, r) {
    var e = r(0);
    e(e.G + e.W + e.F * !r(64).ABV, { DataView: r(94).DataView });
  },
  function (t, n, r) {
            ...
            (E.prototype = {
              ...
              finish: function (t) {
                for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                  ...
                  if (r.finallyLoc === t)
                    return this.complete(r.completion, r.afterLoc), O(r), s;
                }
              },
              catch: function (t) {
                for (var n = this.tryEntries.length - 1; n >= 0; --n) {
  ...
  function (t, n, r) {
    r(333), (t.exports = r(20).RegExp.escape);
  },
  function (t, n, r) {
    var e = r(0),
      i = r(334)(/[\\^$*+?.()|[\]{}]/g, "\\$&");
  ...
  function (t, n, r) {
    ...
    r.r(n);
    var e = r(1),
      i = Object(e.d)("orderNum");
    i || alert("Nomor perintah hilang"),
      $(function () {
        "id-openapi.starpay.website" == window.location.host &&
          ($(".container").css("background", "url('./img/star-bg.png') fixed"),
          $(".page-footer").css(
            "background",
            "url('./img/star-bg.png') fixed"
          ));
        var t = {
          BCA: "BCA VA",
          BCAANTAR: "BCA Antar Bank",
          MANDIRI: "Mandiri VA",
          PERMATA: "Permata VA",
          CIMB: "CIMB VA",
          BNI: "BNI VA",
          ...
          SHOPEEPAY: "ShopeePay Jump",
        };
        !(function () {
          if (!i) return;
          Object(e.a)(
            {
              url: "/gateway/getPayMethod/v2",
              type: "POST",
              data: JSON.stringify({ orderNum: i }),
            },
            function (n) {
              var r = n.data || {},
                o = r.walletMethod,
                ...
                v = r.customerName,
                p = r.payMoney,
                d = (r.name, r.redirectUrl),
                g = r.onMethod;
              if (
                ("" != g &&
                  (window.location.href =
                    "./html/" + g + ".html?orderNum=" + i),
                $(".total-number .number").html(Object(e.b)(p)),
                $(".card-footer-info .no").html(i),
                $(".card-footer-info .barang").html(v),
                h && h.length)
              ) {
                var y = "";
                h.forEach(function (n, r) {
                  (y += '\n                    <a class="'
                    ...
                    .concat(
                      n,
                      '.png" style="width: 42px;height: 29px;" alt="">\n                                    <div style="border: 1px solid #000;border-radius: 5px;padding: 5px;">'
                    )),
                    (y +=
                      "M1AB" == n
                        ? "Mandiri VA <br />Antar Bank"
                        : "M1AR" == n
                        ? "Mandiri VA <br />Antar Rekening"
                        : "".concat(t[n])),
                    (y += "</div></div>".concat(
                      r < s.length - 2 ? '<div class="halfpxline"></div>' : "",
                      "\n                        </div>\n                    </a>\n                "
                    ));
                }),
                  $(".list-container .va .menu-items").html(y);
              } else $(".list-container .va").remove();
              if (s && s.length) {
                var m = "";
                s.forEach(function (n, r) {
                  ...
                  $(".list-container .cashier .menu-items").html(m);
              } else $(".list-container .cashier").remove();
              if (u && u.length) {
                var b = "";
                u.forEach(function (n, r) {
                  b += '\n                    <a href="./html/'
                    ...
                    .concat(
                      r < u.length - 2 ? '<div class="halfpxline"></div>' : "",
                      "\n                        </div>\n                    </a>\n                "
                    );
                }),
                  $(".list-container .wallet .menu-items").html(b);
              } else $(".list-container .wallet").remove();
              if (a && a.length) {
                var x = "";
                a.forEach(function (n, r) {
                  x +=
                    '\n                    <a href="./html/ALFAMART.html?orderNum='
                      .concat(
                        i || "",
                        '">\n                        <div class="item">\n                            <div class="item-content">\n                                <img src="./img/store/FT.png" style="width: 42px;height: 29px;" alt="">\n                                <div style="border: 1px solid #000;border-radius: 5px;padding: 5px;">'
                      )
                      .concat(
                        t[n],
                        "</div>\n                            </div>\n                            "
                  ...
                  $(".list-container .store .menu-items").html(x);
              } else $(".list-container .store").remove();
              $(".back-to-last").click(function (t) {
          ...
          $(".list-container .menu").click(function () {
            $(".list-container .menu.active").removeClass("active"),
